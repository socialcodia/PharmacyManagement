    ...
    <div class="socialcodia" >
        <div class="row">
            <div class="col s12 l6 m6">
                 <div class="card-panel white lighten-4 z-depth-0" style="min-height: 518px;" >
                  <div class="card-image center">
                    <img src="img/user.png" alt="" class="responsive-img circle z-depth-3" style="width: 120px; border: 3px solid gray;">
                        ...
                        <table>
                            <thead>
                                <tr>
                                    <th>Contact</th>
                                    <td class="blue-text"><?php echo $seller->sellerContactNumber; ?></td>
                                </tr>
                                <tr>
                                    <th>Contact 1</th>
                                    <td class="blue-text"><?php echo $seller->sellerContactNumber1; ?></td>
                                </tr>
                                <tr>
                                    <th>Address</th>
                                    <td class="blue-text"><?php echo $seller->sellerAddress; ?></td>
                                </tr>
                            </thead>
                        </table>
                    </div>
